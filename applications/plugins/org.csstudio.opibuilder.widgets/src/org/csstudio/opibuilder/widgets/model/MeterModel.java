...
//		addPVProperty(new StringListProperty(PROP_PVNAME, "PV_Name", WidgetPropertyCategory.Basic,""), new PVValueProperty(PROP_PVVALUE, null));
//		setPropertyDescription(PROP_PVNAME, new );

...
public class InterfaceTable {
   ...
   public double getIfMtu() {
      return ifMtu;
   }
   
   /** @param newIfMtu
    * @pdOid 344e3def-9a6a-4806-845a-8a0bf729bdb9 */
   public void setIfMtu(double newIfMtu) {
      ifMtu = newIfMtu;
   }
   ...
   public void setIfSpeed(double newIfSpeed) {
      ifSpeed = newIfSpeed;
   }
   ...
   public void setIfInoctets(double newIfInoctets) {
   ...
   public void setIfInNUcastPkts(double newIfInNUcastPkts) {
   ...
   public void setIfInDiscards(double newIfInDiscards) {
   ...
   public void setIfInErrors(double newIfInErrors) {
   ...
   public void setIfOutOctets(double newIfOutOctets) {
   ...
   public void setIfOutUcastPkts(double newIfOutUcastPkts) {
   ...
   public void setIfOutErrors(double newIfOutErrors) {
   ...
   public void setIfOutQLen(double newIfOutQLen) {

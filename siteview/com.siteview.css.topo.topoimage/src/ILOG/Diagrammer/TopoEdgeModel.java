...
import org.csstudio.opibuilder.model.ConnectionModel.ArrowType;
...
public class TopoEdgeModel extends AbstractWidgetModel implements IPVWidgetModel {

	private PVWidgetModelDelegate delegate;
	
	public static final String ID = "com.siteview.css.topo.editparts.TopoEdgeModel";
	public TopoEdgeModel() {
	}
	 ...
	 */
	public TopoEdgeModel(DisplayModel displayModel) {
	...
	protected void configureProperties() {
		...
		setPropertyValue(PROP_PVNAME, "sv://topo");

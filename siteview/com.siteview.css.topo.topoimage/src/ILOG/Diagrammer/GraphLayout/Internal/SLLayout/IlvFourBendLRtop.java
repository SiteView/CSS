...
public final class IlvFourBendLRtop extends IlvFourBendLinkShapeType {
	public static LinkShapeType instance = new IlvFourBendLRtop();
	...
	public LinkShapeType GetReversedShapeType() {
		...
		return IlvFourBendRLtop.instance;

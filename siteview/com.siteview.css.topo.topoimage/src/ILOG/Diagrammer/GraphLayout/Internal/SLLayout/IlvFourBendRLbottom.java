...
public final class IlvFourBendRLbottom extends IlvFourBendLinkShapeType {
	public static LinkShapeType instance = new IlvFourBendRLbottom();
	...
	public LinkShapeType GetReversedShapeType() {
		...
		return IlvFourBendLRbottom.instance;

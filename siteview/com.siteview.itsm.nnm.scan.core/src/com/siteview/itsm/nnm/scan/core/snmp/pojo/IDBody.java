...
public class IDBody {
	...
	private Vector<String> ips = new Vector<String>();//IP��ַ1.3.6.1.2.1.4.20.1.3
	private Vector<String> infinxs = new Vector<String>();//IP��ַ��Ӧ������1.3.6.1.2.1.4.20.1.2
	private Vector<String> msks = new Vector<String>();//MASK��ַ1.3.6.1.2.1.4.20.1.3
	private Vector<String> macs = new Vector<String>();//MAC��ַ1.3.6.1.2.1.2.2.1.6
